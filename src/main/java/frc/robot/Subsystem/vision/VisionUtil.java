...
public class VisionUtil {
  ...
  private static final double MA_VISION_STD_DEV_XY = 0.1;
  private static final double MA_VISION_STD_DEV_THETA = Units.degreesToRadians(5.0);
  private static final double MA_AMBIGUITY = 0.2;
  ...
  public enum VisionMode {
    ...
    private static boolean baseAcceptVisionMeasurement(PoseEstimate poseEst) {
      ...
      return !invalidPose(poseEst.robotPose())
  ...
  private static boolean invalidPose(Pose3d robotPose) {
    ...
    double z = robotPose.getZ();

    double margin = FIELD_MARGIN_METERS;
    double maxX = FIELD_LENGTH_METERS + margin;
    double maxY = FIELD_WIDTH_METERS + margin;
    double minX = -margin;
    double minY = -margin;
    double minZ = -Z_MARGIN_METERS;
    double maxZ = Z_MARGIN_METERS;
